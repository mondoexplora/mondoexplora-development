...
}5:["$","main",null,{"className":"min-h-screen","children":[["$","$L10",null,{"pageType":"destination","destination":"Siem Reap","country":"Cambodia","hotelCount":6,"minPrice":14}],["$","script",null,{"type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"$11"}}],"$L12","$L13","$L14"]}]
