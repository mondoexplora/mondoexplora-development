...
}6:["$","main",null,{"className":"min-h-screen","children":[["$","$L12",null,{"pageType":"destination","destination":"Sanur","country":"Indonesia","hotelCount":7,"minPrice":73}],["$","script",null,{"type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"$13"}}],"$L14","$L15","$L16"]}]
